              ...
              <Container>
                  ...
                  <Navbar.Collapse id="responsive-navbar-nav">
                      <Nav className="me-auto">
                          <Nav.Link className="scalable" href="#about-me">{t(lang, 'general.aboutMe')}</Nav.Link>
                          <Nav.Link className="scalable" href="#service-list">{t(lang, 'general.services')}</Nav.Link>
                          <Nav.Link className="scalable" href="#contact">{t(lang, 'general.contact')}</Nav.Link>
                      </Nav>
